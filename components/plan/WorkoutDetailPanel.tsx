        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <button
            ...
            style={{
              ...
              height: 57.5,
              borderRadius: 14,
              border: isCompleted ? "none" : isFuture ? "none" : "1.5px solid #0088FF",
              backgroundColor: isCompleted ? "#F3F4F6" : isFuture ? "#F3F4F6" : "#FFFFFF",
              color: isCompleted ? "#99A1AF" : isFuture ? "#99A1AF" : "#0088FF",
              fontWeight: 600,
              fontSize: 18,
              lineHeight: "1.42em",
