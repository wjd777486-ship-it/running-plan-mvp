...
[훈련 설계 원칙]
페이스 계산 (Jack Daniels VDOT 기반, 반드시 준수):
- 검증 결과의 "현재 VDOT" 값을 기준으로 아래 기준표에서 훈련 페이스를 산출
- HR 데이터 페이스나 목표 레이스 페이스 기반 계산 금지
- Easy 페이스는 조깅 데이터(HR<140)와 VDOT E-pace 중 더 느린 쪽 사용
...
VDOT | Easy  | 템포  | 인터벌
 ...
 58  | 4:45  | 3:59  | 3:36
 60  | 4:39  | 3:53  | 3:30
- VDOT가 표에 없으면 인접 값 사이를 보간
- LSD: Easy 페이스보다 15~25초 느리게
- 워밍업/쿨다운/인터벌 회복 조깅: Easy 페이스 사용
